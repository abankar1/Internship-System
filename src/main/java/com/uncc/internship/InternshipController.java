...
public class InternshipController {
	...
	@RequestMapping(value = "/internshipdetails/{internshipID}", method = RequestMethod.GET)
	public ModelAndView listInternshipDetail(@PathVariable("internshipID") String internshipID, Model model) {
		logger.info("listInternshipDetail get");
	...
	public ModelAndView listInternshipDetails(@PathVariable("internshipID") String internshipID, Model model) {
		logger.info("listInternshipDetail post");
		StringBuilder internshipDetail = internshipService.getIntershipDetails(internshipID);
	...
	public ModelAndView getCompanyIntershipOffer(@PathVariable("companyID") String companyID, Model model) {
		logger.info("getCompanyIntershipOffer get");
	...
	@RequestMapping(value = "/companyDetails/{companyID}", method = RequestMethod.POST)
	public ModelAndView getCompaniesIntershipOffer(@PathVariable("companyID") String companyID, Model model) {
		logger.info("getCompanyIntershipOffer post");
		StringBuilder internshipDetail = internshipService.getCompaniesIntershipOffer(companyID);
